              ...
              <View>
                ...
                {activeEntity ? (
                  <View>
                    ...
                    <View style={styles.chipsRow}>
                      <Chip label="Nenhuma" active={entityBoostCardIds.length === 0} onPress={() => setEntityBoostCardIds([])} testID="online-play-entity-boost-none" />
                      {selectedCards.map(card => (
                        <Chip
                          key={card.id}
                          label={card.name}
                          ...
                          testID={`online-play-entity-boost-${card.id}`}
                        />
                      ))}
                    </View>
