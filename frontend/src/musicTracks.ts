export const musicTracks = [
  ...
  require('../assets/music/55.mp3'),
  require('../assets/music/56.mp3'),
  require('../assets/music/57.mp3'),
  require('../assets/music/58.mp3'),
  require('../assets/music/59.mp3'),
  require('../assets/music/60.mp3'),
  // To add more local tracks, add numbered files to frontend/assets/music/
  // and append their static require here, for example:
  // require('../assets/music/61.mp3'),
];
